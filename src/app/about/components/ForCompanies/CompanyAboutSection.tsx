          ...
          >
            ...
            <Box w={{ base: '90%', md: '90%' }} textAlign="justify">
              ...
              <Text color="#121212" fontSize={{ base: '16px', md: '18px' }} mt={2}>
                We believe students deserve to be seen for their skills, projects, and creativity
                not just their test scores.
              </Text>

              <Text mt={8} color="#121212" fontSize={{ base: '16px', md: '18px' }}>
                We saw how hard it is to stand out, build connections, and find real opportunities
                while still learning. So we built{' '}
                <Text as="span" fontWeight="semibold">
                  EduPons
                </Text>{' '}
                a space where you can showcase what you do best, join exciting challenges, and get
                noticed by educators and companies that value your potential.
              </Text>

              <Text mt={8} color="#121212" fontSize={{ base: '16px', md: '18px' }}>
                Because when your learning connects with real-world opportunity, your journey truly
                begins.
              </Text>
            </Box>
          </Stack>
